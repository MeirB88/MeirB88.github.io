...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'MBTV Wizard'
BUILDERNAME = 'mbtvwizard'
EXCLUDES = [ADDON_ID, 'repository.mbtvwizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.mbtvwizard/wiki/Installing-Builds
BUILDFILE = 'https://meirb88.github.io/files/builds.txt'
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing mbtvwizard.\n\nContact us on Github at http://www.github.com/drinfernoo/plugin.program.mbtvwizard/'
...
REPOADDONXML = 'https://meirb88.github.io/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://meirb88.github.io/repo/zips'
#########################################################
