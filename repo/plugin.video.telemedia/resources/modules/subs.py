...
def get_login_cook():
    ...
    login_cook = get_html('https://www.ktuvit.me/Services/MembershipService.svc/Login', headers=headers, data=data).cookies
    login_cook_fix={}
...
def FirstPlace_Search(item,imdb_id,subtitle_list,check_one=False):
    ...
    if 1:
        ...
        response = get_html('https://www.ktuvit.me/Services/ContentProvider.svc/SearchPage_search', headers=headers, data=data).json()
        ...
        if item["tvshow"]:
            ...
            response = get_html('https://www.ktuvit.me/Services/GetModuleAjax.ashx', headers=headers, params=params, cookies=login_cook).content
        else:
            headers = {
                'authority': 'www.ktuvit.me',
            ...
            response = get_html('https://www.ktuvit.me/MovieInfo.aspx', headers=headers, params=params, cookies=login_cook).content
