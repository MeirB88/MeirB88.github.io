...
class FirebaseApplication(object):
    ...
    def get_async(self, url, name, callback=None, params=None, headers=None):
        ...
        self._authenticate(params, headers)
        thread=[]
        thread.append(Thread(make_get_request,endpoint, params, headers))
        thread[len(thread)-1].setName('make_get_request ')
    ...
    def put_async(self, url, name, data, callback=None, params=None, headers=None):
        ...
        data = json.dumps(data, cls=JSONEncoder)
        thread=[]
        thread.append(Thread(make_put_request,endpoint, data, params, headers))
        thread[len(thread)-1].setName('make_put_request ')
        thread[len(thread)-1].start()
    ...
    def post_async(self, url, data, callback=None, params=None, headers=None):
        ...
        data = json.dumps(data, cls=JSONEncoder)
        thread=[]
        thread.append(Thread(make_post_request,endpoint, data, params, headers))
        thread[len(thread)-1].setName('make_post_request ')
        thread[len(thread)-1].start()
    ...
    def patch_async(self, url, data, callback=None, params=None, headers=None):
        ...
        data = json.dumps(data, cls=JSONEncoder)
        thread=[]
        thread.append(Thread(make_patch_request,endpoint, data, params, headers))
        thread[len(thread)-1].setName('make_patch_request ')
        thread[len(thread)-1].start()
    ...
    def delete_async(self, url, name, callback=None, params=None, headers=None):
        ...
        self._authenticate(params, headers)
        thread=[]
        thread.append(Thread(make_delete_request,endpoint, params, headers))
        thread[len(thread)-1].setName('make_delete_request ')
        thread[len(thread)-1].start()
